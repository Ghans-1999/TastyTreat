          ...
          <Row>
            <Col lg="2" md="2">
              <div className="product__images">
                ...
                >
                  <img src={product.image01} alt="" className="w-50 image-div" />
                </div>
                <div
                  className="img__item mb-3"
                  onClick={() => setPreviewImg(product.image02)}
                >
                  <img src={product.image02} alt="" className="w-50 image-div" />
                </div>
                ...
                >
                  <img src={product.image03} alt="" className="w-50 image-div" />
                </div>
              </div>
            </Col>
